        ...
        <div className="container">
          <div className="upper-text-container">
            ...
            <p>
              ...
              Restrictions and other <a href="https://www.apple.com/promo/">terms </a> apply.
            </p>
          </div>
          ...
          <div className="copyright-wrapper row">
            ...
            {/* Fixed: Changed text-md-right to text-md-end for Modern Bootstrap compatibility */}
            <div className="footer-country col-sm-12 order-1 col-md-4 order-md-2 text-md-end col-lg-2 order-lg-3">
              <div className="flag-wrapper">
                <img src={icons} alt="United States Flag" />
              </div>{" "}
